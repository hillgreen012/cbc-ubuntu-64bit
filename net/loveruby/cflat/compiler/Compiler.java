...
public class Compiler {
	...
	// #@@range/assemble{
	public void assemble(String srcPath, String destPath, Options opts) throws IPCException {
	...
	private void writeFile(String path, String str) throws FileException {
		...
		try {
			BufferedWriter f = new BufferedWriter(new OutputStreamWriter(new FileOutputStream(path)));
			try {
				f.write(str);
			} finally {
				f.close();
