...
public class LocalScope extends Scope {
	...
	/**
	 * Returns all local variables in this scope. The result DOES includes all
	 * nested local variables, while it does NOT include static local variables.
	 */
	...
	/**
	 * Returns local variables defined in this scope. Does NOT includes children's
	 * local variables. Does NOT include static local variables.
	 */
